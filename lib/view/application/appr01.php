    ...
    <div class="" id="form2">
        ...
        <form id="empform">
            ...
            <label class="form-label mt-2 ">Company Address</label>
                <input type="text" name="comaddress" id="comaddress" class="form-control" placeholder="Company Address">
            </div>
            <div class="form-group px-5">
            <label class="form-label mt-2 ">Owners Name</label>
                <input type="text" name="comoname" id="comoname" class="form-control" placeholder="Company Owners Name">
            </div>
            <div class="form-group px-5">
            ...
            <label class="form-label mt-2 ">Employee Number</label>
                <input type="text" name="number" id="number" class="form-control" placeholder="Employee Number">
            </div>
            <div class="form-group px-5">
        ...
        <div class="form-group my-2">
                <button class="btn btn-success" onclick="ok1()">Approved</button>
                <button class="btn btn-secondary" onclick="backlist()">Application List</button>
        </div>
    </div>
...
<script>
    $(document).ready(function(){
        ...
        $.get("../routes/application/appr01.php", function (res) {
        //display data 
        $("#pro_list").html(res);
        })
        ...
        $("#search_circular").on('input',function(){
            ...
            $.get("../routes/application/appr01s.php",{searchData:$inputData},function(res){
                $("#pro_list").html(res);
            })
        })
    })
     ...
     function ok1(){
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.get("../routes/application/appr01ok.php", {
            id:$('#ID').val(),
            cname:$('#comname').val(),
            caddress:$('#comaddress').val(),
            coname:$('#comoname').val(),
            name:$('#name').val(),
            number:$('#number').val(),
            date:$('#date2').val(),
    ...
    function not1(){
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.get("../routes/application/appr01not.php", {
            id:$('#ID').val(),
            error:$('#error').val(),
