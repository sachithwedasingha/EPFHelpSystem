...
<script>
    $(document).ready(function(){
        ...
        $.get("../routes/application/appr03.php", function (res) {
        //display data 
        $("#pro_list").html(res);
        })
        ...
        $("#search_circular").on('input',function(){
            ...
            $.get("../routes/application/appr03s.php",{searchData:$inputData},function(res){
                $("#pro_list").html(res);
            })
        })
    })
     ...
     function ok(){
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.get("../routes/application/appr03ok.php", {
                    id:$('#ID').val(),
                }, function (res) {
    ...
    function not1(){
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.get("../routes/application/appr03not.php", {
            id:$('#ID').val(),
            error:$('#error').val(),
