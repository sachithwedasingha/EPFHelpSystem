          ...
          <ul>
            ...
            <li class="sidebar-dropdown">
              ...
              <div class="sidebar-submenu">
                <ul>
                  <li>
                    <a id="add_product">Add Circular</a>
                  </li>
                  <li>
                    <a id="edit_product">Edit Circulars</a>
                  </li>
                </ul>
              </div>
            </li>
            <li class="sidebar-dropdown">
              ...
              <i class="fas fa-shopping-bag"></i>
                <span>Manage Form-B</span>
              </a>
              <div class="sidebar-submenu">
                <ul>
                  <li>
                    <a href="#" id="all">All Applications</a>
                  </li>
                  <li>
                    <a href="#" id="appr01">Enployers apruwal</a>
                  </li>
                  <li>
                    <a href="#" id="appr02">clarical</a>
                  </li>
                  <li>
                    <a href="#" id="appr03">HB</a>
                  </li>
                  <li>
                    <a href="#" id="appr04">ACL</a>
                  </li>
                </ul>
              </div>
            </li>
            <li class="sidebar-dropdown">
              ...
              <div class="sidebar-submenu">
                <ul>
                  <li>
                    <a href="invoice/Total application.php">Total Application Report</a>
                  </li>
                  <li>
                    <a href="invoice/print application.php">Print Application</a>
                  </li>
                  <li>
                    <a href="invoice/annual application report.php">Annual Application Report</a>
                  </li>
                </ul>
              </div>
            </li>
