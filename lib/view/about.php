<?php 
include_once('../layout/top Nav_main2.php'); 
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
				<div class="about_img wow slideInRight pt-5">
					<img src="../upload/ui/pngwing.com (2).png" id="imghver" width="300px" class="img-responsive">
				</div>
			</div> 
		</div>
	</div>
...
<section id="choose">
	<div class="container">
		<div class="row">
			<div class="title">
				<h2 style="color: red;text-align:center">WHY CHOOSE US?</h2>
...
<section id="customer">
	<div class="container">
		<div class="row">
			<div class="title">
				<h2 style="color: red;text-align:center">CUSTOMER REVIEWS</h2>
				<p style="color: white;text-align:center">Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit,</p>
			</div>
			    ...
			    <div class="item col-4">
			    	<div class="single_customer">
			    		<div class="customer_content">
			    			<p><span><img src="../upload/ui/qute.png" alt=""></span> Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit,</p>
			    		</div>
			    		<div class="user_id">
			...
			<div class="footer_title">
				...
				<div class="footer_content">
					<ul class="contact_details">
						<li><a href="#"><span><i class="fa fa-map-marker" aria-hidden="true"></i></span>No.21, New Town, Lunuwatta</a></li>
						<li><a href="#"><span><i class="fa fa-envelope" aria-hidden="true"></i></span>dimuthuagrocenter@gmail.com</a></li>
						<li><a href="#"><span><i class="fa fa-phone" aria-hidden="true"></i></span>+44 00 00 1234 <br>+44 00 00 1234</a></li>
					</ul>
				</div>
			</div>
			<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12" >
			<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2800.4684661746114!2d80.92273239609774!3d6.954881594917003!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae47dae34358281%3A0x4ee62ee6886a4c93!2sDimuthu%20Super%20Grocery!5e0!3m2!1sen!2slk!4v1657880050452!5m2!1sen!2slk" width="400" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
			</div>
		</div>
	</div>
</footer>
